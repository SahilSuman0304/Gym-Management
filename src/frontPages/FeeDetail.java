...
public class FeeDetail extends JFrame {
	...
	public FeeDetail() {
		...
		JLabel lblNewLabel_1 = new JLabel("FEE DETAILS");
		...
		scrollPane.setBounds(193, 138, 1046, 414);
		panel_1.add(scrollPane);
		
		table = new JTable();
		scrollPane.setViewportView(table);
		Connection con=DBUtility.connection();
		String query="select * from memberfee";
		try {
		...
		panel_1.add(btnExit);
		  ...
		  back.setForeground(new Color(139, 69, 19));
			...
			btnNewButton.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e)
				{
					...
					else
					{
						...
						String query="select * from memberfee where MemberId="+id;
						try {
							PreparedStatement stmt=con.prepareStatement(query);
							ResultSet rs=stmt.executeQuery();
							table.setModel(DbUtils.resultSetToTableModel(rs));
			...
			JButton btnNewButton_1 = new JButton("TOTAL FEE DETAILS");
			...
			btnNewButton_1.setBounds(931, 97, 225, 23);
