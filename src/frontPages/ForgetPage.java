...
public class ForgetPage extends JFrame {
	...
	public ForgetPage() {
		...
		lblNewLabel_2.setBounds(546, 152, 133, 38);
		panel_1.add(lblNewLabel_2);
		
		JLabel v1 = new JLabel("*");
		v1.setForeground(Color.RED);
		v1.setBounds(905, 164, 161, 23);
		panel_1.add(v1);
		
		idB = new JTextField();
		idB.setFont(new Font("Tahoma", Font.ITALIC, 15));
		idB.setColumns(10);
		idB.setBounds(689, 160, 206, 23);
		idB.addKeyListener(new KeyAdapter() {
			@Override
		...
		lblNewLabel.setBounds(546, 212, 133, 38);
		panel_1.add(lblNewLabel);
		
		user = new JTextField();
		user.setFont(new Font("Tahoma", Font.ITALIC, 15));
		user.setBounds(689, 222, 206, 23);
		panel_1.add(user);
		user.setColumns(10);
		...
		cnpassword.setBounds(473, 338, 206, 27);
			...
			public void actionPerformed(ActionEvent e) {
					...
					Login l=new Login();
						...
						else if(password.equals(cpassword))
						{
						    ...
						    boolean flag=l.forgetPassword(id1, username, cpassword);
		...
		btnNewButton.setBounds(546, 409, 345, 36);
		...
		newuser.setBounds(473, 479, 133, 38);
		panel_1.add(newuser);
		...
		ebuttom.setBounds(610, 542, 196, 36);
		panel_1.add(ebuttom);
